 ...
 */
export async function loadAppConfig(doc) {
    try {
 ...
 */
export function matchesUserId(ownerId, currentUserId, currentUserEmail) {
 ...
 */
export function canUserDeleteTask(config, userRole, taskOwnerId, initiativeOwnerId, currentUserId, currentUserEmail) {
 ...
 */
export function logActivity(req, type, description, metadata) {
