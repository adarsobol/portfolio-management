...
// ============================================
router.post('/errors', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
// ============================================
router.post('/activity', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
