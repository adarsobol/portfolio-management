...
// ============================================
router.post('/google', loginLimiter, validate(googleAuthSchema), async (req: Request, res: Response) => {
  try {
    ...
    let savedLastLogin: string | null = loginTimestamp;
    try {
      await userRow.save();
...
// ============================================
router.post('/register', authenticateToken, validate(registerUserSchema), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.get('/users', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    serverLogger.error('Get users error', { context: 'Auth', error: error as Error });
